...
export declare const defaultInfoviewConfig: InfoviewConfig;
export type InfoviewActionKind = 'toggleAllMessages' | 'togglePaused' | 'togglePin' | 'copyToComment' | 'toggleExpectedType';
